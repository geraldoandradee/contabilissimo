...
namespace Contabilissimo\Library\Http;
use Contabilissimo\Library\Exceptions\Http\ResponseAlreadySentException;
use Contabilissimo\Library\Exceptions\LockedResponseException;
